...
export const zh = {
  ...
  'spark.empty': '暂无数据',
  'note.pricing': '按官方价目逐笔计价（含思考 token；与平台逐请求计费同口径，仍为估算）',
  'window.peak': '⛰️ 高峰价',
  'window.offpeak': '🌙 闲时价',
  'chip.standard': '现行一口价',
  'chip.peak': '⛰️ 高峰',
...
export const en: Record<RichKey, string> = {
  ...
  'note.pricing': "Official list prices per usage event; reasoning included — same per-request口径 as the platform bill, still an estimate",
  'window.peak': '⛰️ peak',
