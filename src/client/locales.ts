...
export const zh = {
  ...
  'spark.empty': '暂无数据',
  'note.pricing': '按官方价目估算（含思考 token；累计按默认模型计价，可能与平台账单有出入）',
  'window.peak': '⛰️ 高峰价',
  'window.offpeak': '🌙 闲时价',
  'rank.0': '🌱 未醒词芽',
  'rank.1': '🥉 词途学徒',
...
export const en: Record<RichKey, string> = {
  ...
  'note.pricing': 'Official list prices; reasoning included; lifetime priced by the default model — may differ from platform billing',
  'window.peak': '⛰️ peak',
