	...
	factory: (require) => {
		...
		function ContextBlock({ pressure, breakdown, subagentMs, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dsh-rich-context",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsh-rich-context-head",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dsh-rich-context-title",
							children: t("sec.context")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dsh-rich-context-value",
							children: percent === null ? "—" : `${percent}%`
						})]
					}),
					percent === null ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-rich-context-bar",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "dsh-rich-context-fill",
							style: { width: `${percent}%` }
						})
					}),
					used !== void 0 && window !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dsh-rich-context-sub",
						children: [
							formatTokens(used),
							" / ",
							formatTokens(window),
					...
					parts !== null && totalParts > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dsh-rich-context-stack",
						...
						className: "dsh-rich-context-legend",
						children: parts.filter((part) => part.tokens > 0).map((part) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: "dsh-rich-context-legend-item",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { className: `dsh-rich-context-dot dsh-rich-context-dot-${part.key}` }),
								part.label,
								" ",
		...
		*/
		...
		function Achievements({ stats, t }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dsh-rich-achievements",
				children: ACHIEVEMENTS.map((achievement) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dsh-rich-ach-emoji",
							children: achievement.emoji
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dsh-rich-ach-name",
							children: t(nameKey)
						})]
					}, achievement.id);
				})
		...
		*/
		function SidebarUsage({ wide, useSessions, api, t }) {
			...
			(0, react.useEffect)(() => {
				const timer = setInterval(() => setTick((value) => value + 1), 5e3);
				return () => clearInterval(timer);
			}, []);
			const [flash, setFlash] = (0, react.useState)(false);
			const prevCostRef = (0, react.useRef)(sessionCost);
			(0, react.useEffect)(() => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					children: wide ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: "dsh-rich-badge",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: "dsh-rich-badge-main",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "dsh-rich-trigger-name",
									children: rankName
								}),
							...
							className: flash ? "dsh-rich-trigger-metrics dsh-rich-flash" : "dsh-rich-trigger-metrics",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "dsh-rich-trigger-sep",
									children: "·"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								ctxPercent === null ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									className: "dsh-rich-trigger-context",
									children: [
										t("sec.context"),
										" ",
										ctxPercent,
