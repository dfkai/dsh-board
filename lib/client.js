window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*  gradient arc with a slowly orbiting sparkle. */
		function BadgeRing({ share, emoji }) {
			const r = 26;
			const c = 2 * Math.PI * r;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dsh-board-ring-emoji",
						children: emoji
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: "dsh-board-ring-spark" })
				]
			});
		}
		/**
					...
					children: wide ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(BadgeRing, {
									share: lifetime.week > 0 ? lifetime.today / lifetime.week : 0,
									emoji: rank.level.emoji
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
