	...
	factory: (require) => {
		...
		const LEVELS = [
			...
			},
			{
				...
				emoji: "🥉",
				zh: "词途学徒",
				en: "Apprentice of the Word-Path",
				color: "#cd7f32"
			},
			{
				floor: 1e5,
		...
		*/
		const MemoMembershipCard = (0, react.memo)(MembershipCard);
		const MemoContextBlock = (0, react.memo)(ContextBlock);
		const MemoHeatmap = (0, react.memo)(Heatmap);
		const MemoCumulativeArea = (0, react.memo)(CumulativeArea);
		const MemoTrendBars = (0, react.memo)(TrendBars);
		const MemoModelRows = (0, react.memo)(ModelRows);
		const MemoSessionRows = (0, react.memo)(SessionRows);
		const MemoAchievements = (0, react.memo)(Achievements);
		const SidebarUsage = (0, react.memo)(function SidebarUsage({ wide, useSessions, api, t }) {
			...
			const panel = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoContextBlock, {
						pressure,
						breakdown,
						subagentMs,
						t
					...
					fold.perTurn.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoTrendBars, { data: fold.perTurn.slice(-24) }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					fold.cumulative.length < 2 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionTitle, { children: t("sec.cumulative") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoCumulativeArea, { values: fold.cumulative.slice(-60) })] }),
					lifetime.daily.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoHeatmap, { daily: lifetime.daily }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "dsh-board-heat-note",
							children: t("heat.note")
						})
					] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoMembershipCard, {
						total: lifetime.total,
						daily: lifetime.daily,
						t
					}),
					models.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionTitle, { children: t("sec.model") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoModelRows, {
						models,
						t
					})] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionTitle, { children: t("sec.achievements") }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoAchievements, {
						stats: usageStats,
						t
					}),
					lifetime.sessions.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SectionTitle, { children: t("sec.global") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemoSessionRows, { sessions: lifetime.sessions })] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			const badgeInner = wide ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				className: "dsh-board-badge",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			const triggerButton = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				ref: rootRef,
				className: wide ? "dsh-board-foot dsh-board-wide" : "dsh-board-foot",
				children: wide ? collapsed ? triggerButton : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dsh-board-float dsh-board-open",
					children: [triggerButton, panel]
				}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [triggerButton, open ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
